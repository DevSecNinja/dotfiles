...
# The libraries are downloaded to tests/bash/libs/ (gitignored).
#
# This mirrors the approach used in DevSecNinja/truenas-apps so the two
# repositories share a consistent BATS testing workflow.
